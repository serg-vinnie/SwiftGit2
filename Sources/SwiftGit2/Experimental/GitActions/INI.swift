...
nonisolated(unsafe) var sectionParser = Parse {
    Skip {
        Prefix { $0 != "\n" }
    }
    Many {
...
nonisolated(unsafe) var titleParser = Parse {
    "["
    Prefix { $0 != "]" }
    Skip {
...
nonisolated(unsafe) var submoduleParser = Parse {
...
nonisolated(unsafe) var sectionsParser = Many {
    Parse {
        StartsWith("[")
        OneOf {
           Prefix { $0 != "[" }
