...
public struct SubmoduleStatusFlags: OptionSet {
    ...
    nonisolated(unsafe) public static let InHead = SubmoduleStatusFlags(rawValue: GIT_SUBMODULE_STATUS_IN_HEAD.rawValue)
    nonisolated(unsafe) public static let InIndex = SubmoduleStatusFlags(rawValue: GIT_SUBMODULE_STATUS_IN_INDEX.rawValue)
    nonisolated(unsafe) public static let InConfig = SubmoduleStatusFlags(rawValue: GIT_SUBMODULE_STATUS_IN_CONFIG.rawValue)
    nonisolated(unsafe) public static let InWd = SubmoduleStatusFlags(rawValue: GIT_SUBMODULE_STATUS_IN_WD.rawValue)
    nonisolated(unsafe) public static let IndexAdded = SubmoduleStatusFlags(rawValue: GIT_SUBMODULE_STATUS_INDEX_ADDED.rawValue)
    nonisolated(unsafe) public static let IndexDeleted = SubmoduleStatusFlags(rawValue: GIT_SUBMODULE_STATUS_INDEX_DELETED.rawValue)
    nonisolated(unsafe) public static let IndexModified = SubmoduleStatusFlags(rawValue: GIT_SUBMODULE_STATUS_INDEX_MODIFIED.rawValue)
    nonisolated(unsafe) public static let WdUninitialized = SubmoduleStatusFlags(rawValue: GIT_SUBMODULE_STATUS_WD_UNINITIALIZED.rawValue)
    nonisolated(unsafe) public static let WdAdded = SubmoduleStatusFlags(rawValue: GIT_SUBMODULE_STATUS_WD_ADDED.rawValue)
    nonisolated(unsafe) public static let WdDeleted = SubmoduleStatusFlags(rawValue: GIT_SUBMODULE_STATUS_WD_DELETED.rawValue)
    nonisolated(unsafe) public static let WdModified = SubmoduleStatusFlags(rawValue: GIT_SUBMODULE_STATUS_WD_MODIFIED.rawValue)
    nonisolated(unsafe) public static let WdIndexModified = SubmoduleStatusFlags(rawValue: GIT_SUBMODULE_STATUS_WD_INDEX_MODIFIED.rawValue)
    nonisolated(unsafe) public static let WdWdModified = SubmoduleStatusFlags(rawValue: GIT_SUBMODULE_STATUS_WD_WD_MODIFIED.rawValue)
    nonisolated(unsafe) public static let WdUntracked = SubmoduleStatusFlags(rawValue: GIT_SUBMODULE_STATUS_WD_UNTRACKED.rawValue)
}
