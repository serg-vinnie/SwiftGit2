...
public extension StashApplyOptions {
    struct Flags: OptionSet {
        ...
        nonisolated(unsafe) public static let `default`         = Flags(rawValue: GIT_STASH_APPLY_DEFAULT.rawValue)
        nonisolated(unsafe) public static let reinstateIndex    = Flags(rawValue: GIT_STASH_APPLY_REINSTATE_INDEX.rawValue)
