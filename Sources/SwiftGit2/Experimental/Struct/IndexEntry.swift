...
public extension Index.Entry {
    struct Flags: OptionSet {
        ...
        nonisolated(unsafe) public static let extended = Flags(rawValue: GIT_INDEX_ENTRY_EXTENDED.rawValue)
        nonisolated(unsafe) public static let valid = Flags(rawValue: GIT_INDEX_ENTRY_VALID.rawValue)
    }
    ...
    struct FlagsExtended: OptionSet {
        ...
        nonisolated(unsafe) public static let intendedToAdd = Flags(rawValue: GIT_INDEX_ENTRY_INTENT_TO_ADD.rawValue)
        nonisolated(unsafe) public static let skipWorkTree = Flags(rawValue: GIT_INDEX_ENTRY_SKIP_WORKTREE.rawValue)
        nonisolated(unsafe) public static let extendedFlags = Flags(rawValue: GIT_INDEX_ENTRY_EXTENDED_FLAGS.rawValue)
        nonisolated(unsafe) public static let update = Flags(rawValue: GIT_INDEX_ENTRY_UPTODATE.rawValue)
    }
}
