...
public extension GitBlame {
    struct Flags: OptionSet {
        ...
        public static let normal                        = Flags(rawValue: GIT_BLAME_NORMAL.rawValue)
        public static let trackCopiesSameFile           = Flags(rawValue: GIT_BLAME_TRACK_COPIES_SAME_FILE.rawValue)
        public static let trackCopiesSameCommitMoves    = Flags(rawValue: GIT_BLAME_TRACK_COPIES_SAME_COMMIT_MOVES.rawValue)
        public static let trackCopiesSameCommitCopies   = Flags(rawValue: GIT_BLAME_TRACK_COPIES_SAME_COMMIT_COPIES.rawValue)
        public static let trackCopiesAnyCommitCopies    = Flags(rawValue: GIT_BLAME_TRACK_COPIES_ANY_COMMIT_COPIES.rawValue)
        public static let firstParent                   = Flags(rawValue: GIT_BLAME_FIRST_PARENT.rawValue)
        public static let useMailmap                    = Flags(rawValue: GIT_BLAME_USE_MAILMAP.rawValue)
        public static let ignoreWhitespace              = Flags(rawValue: GIT_BLAME_IGNORE_WHITESPACE.rawValue)
